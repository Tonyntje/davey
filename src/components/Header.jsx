          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-shrink-0 flex items-center">
              <a href="/" className="flex items-center">
                <img src="/Transparant.svg" alt="Duif Tegelwerken" className="h-[65px] w-auto" />
              </a>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-6 lg:space-x-8">
              {navLinks.map((link) => (
                <a 
                  key={link.title} 
                  href={link.href} 
                  className="font-playfair text-sm font-bold tracking-widest text-brand-black hover:text-gray-500 transition-colors flex items-center"
                >
                  {link.isHome ? (
        ...
        <div className="md:hidden bg-white absolute top-full left-0 w-full shadow-xl border-t border-gray-100 h-screen flex flex-col pt-8 z-20">
          <div className="px-6 flex flex-col space-y-2">
            ...
            <div className="border border-gray-200 p-6 mt-6">
              <h3 className="font-playfair font-bold tracking-widest mb-4">BEL OF MAIL</h3>
